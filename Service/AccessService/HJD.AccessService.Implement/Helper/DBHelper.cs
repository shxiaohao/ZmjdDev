...
namespace HJD.AccessService.Implement.Helper
{
    public sealed class DBHelper
    {
        ...
        //public static string CommentDbConn = "Data Source=192.168.1.113;Initial Catalog=CommentDB;Persist Security Info=True;User ID=sa;Password=password01!";
        public static string CommentDbConn = "Server=rdss9am4323erjo9qjsx.sqlserver.rds.aliyuncs.com,3433;UID=appuser;password=C1g8oC__JcW_C1g8oC__JcW_;database=CommentDB;";
        ...
        public static int ExecuteNonQueryTypedParams(string connectionString, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {

                returnValue = DBHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
        ...
        public static DataSet ExecuteDatasetTypedParams(string connectionString, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {

                returnValue = DBHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {

                returnValue = DBHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {

                returnValue = DBHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
        ...
        public static SqlDataReader ExecuteReaderTypedParams(string connectionString, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
        ...
        public static object ExecuteScalarTypedParams(string connectionString, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static object ExecuteScalarTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static object ExecuteScalarTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DBHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DBHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
