...
namespace HJD.AccessServiceTask.Job
{
    ...
    /// 下载指定微信号的永久素材数据
    /// </summary>
    public class DownLoadWexinMaterialJob : BaseJob
    {
        static string weixinAcount = "zmjiudian";
        static int categoryId = 1;
        static int WeixinAcountId = 1;

        public DownLoadWexinMaterialJob()
            : base("DownLoadWexinMaterialJob")
        {
            Log(string.Format("Start Job [DownLoadWexinMaterialJob]"));
            ...
            {
                Log("Job [DownLoadWexinMaterialJob] Error:" + ex.Message);
            }


            Log(string.Format("Stop Job [DownLoadWexinMaterialJob]"));
        }
        ...
        static string lastOffsetFile = @"D:\Log\Config\Weixin\WeixinMaterial_LastOffset_{0}.txt";
        ...
        private int GetLastOffset()
        {
            ...
            lastOffsetFile = string.Format(@"D:\Log\Config\Weixin\WeixinMaterial_LastOffset_{0}.txt", now.ToString("yyyyMMdd"));
