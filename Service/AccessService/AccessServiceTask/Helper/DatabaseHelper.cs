...
namespace HJD.AccessServiceTask.Helper
{
    public class DatabaseHelper
    {
        ...
        /// 链接字符串
        /// </summary>
        public static string HotelDbConn = System.Configuration.ConfigurationManager.ConnectionStrings["hotelDB"].ConnectionString;
        public static string CommentDbConn = System.Configuration.ConfigurationManager.ConnectionStrings["CommentDB"].ConnectionString;
        public static string DestDbConn = System.Configuration.ConfigurationManager.ConnectionStrings["destDB"].ConnectionString;
        public static string AcountDbConn = System.Configuration.ConfigurationManager.ConnectionStrings["AcountDB"].ConnectionString;
        public static string CommDbConn = System.Configuration.ConfigurationManager.ConnectionStrings["CommDB"].ConnectionString;
        ...
        public static int ExecuteNonQueryTypedParams(string connectionString, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {

                returnValue = DatabaseHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
        ...
        public static DataSet ExecuteDatasetTypedParams(string connectionString, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {

                returnValue = DatabaseHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {

                returnValue = DatabaseHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {

                returnValue = DatabaseHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
        ...
        public static SqlDataReader ExecuteReaderTypedParams(string connectionString, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
        ...
        public static object ExecuteScalarTypedParams(string connectionString, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static object ExecuteScalarTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static object ExecuteScalarTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlConnection connection, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                returnValue = DatabaseHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                returnValue = DatabaseHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
            }
            return returnValue;
        }
        #endregion
