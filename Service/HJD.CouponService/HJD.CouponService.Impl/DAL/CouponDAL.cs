...
namespace HJD.CouponService.Impl.DAL
{
    public class CouponDAL
    {
        ...
        public static int GetExchangCouponCountByCouponOrderID(long couponOrderID, int state)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("@CouponOrderID", couponOrderID);
            parameters.Add("@State", state);
            object obj = CouponDB.ExecuteSqlStringAndReturnSingleField("CouponDB.GetExchangCouponCountByCouponOrderID", parameters);
        ...
        public static List<UserCouponDefineEntity> GetCouponCondationByMarketingType(int intVal, int condationType, int marketingType)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("@IntVal", intVal);
            parameters.Add("@CondationType", condationType);
            parameters.Add("@MarketingType", marketingType);
            return CouponDB.ExecuteSqlString<UserCouponDefineEntity>("CouponDB.GetCouponCondationByMarketingType", parameters);
        }
    }
}