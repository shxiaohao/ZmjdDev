...
namespace Com.Alipay
{
    ...
    //    private static string _sign_type = "";
        ...
        public static string BuildRequestMysign(Dictionary<string, string> sPara, string _sign_type)
        {
        ...
        private static Dictionary<string, string> BuildRequestPara(Dictionary<string, string> sParaTemp, string _sign_type)
        {
            //待签名请求参数数组
            ...
            //获得签名结果
            mysign = BuildRequestMysign(sPara,  _sign_type);
        ...
        private static string BuildRequestParaToString(Dictionary<string, string> sParaTemp, Encoding code, string _sign_type)
        {
            //待签名请求参数数组
            Dictionary<string, string> sPara = new Dictionary<string, string>();
            sPara = BuildRequestPara(sParaTemp,  _sign_type);
        ...
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string strMethod, string strButtonValue, string _sign_type)
        {
            //待请求参数数组
            Dictionary<string, string> dicPara = new Dictionary<string, string>();
            dicPara = BuildRequestPara(sParaTemp,  _sign_type);
        ...
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string _sign_type)
        {
            Encoding code = Encoding.GetEncoding(_input_charset);

            //待请求参数数组字符串
            string strRequestData = BuildRequestParaToString(sParaTemp,code,  _sign_type);
        ...
        /// <returns>支付宝处理结果</returns>
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string strMethod, string fileName, byte[] data, string contentType, int lengthFile, string _sign_type)
        {
        ...
        public static Dictionary<string, string> ParseResponse(string strText, string _sign_type)
        {
            //以“&”字符切割字符串
            ...
            if (dicText.ContainsKey("res_data") && dicText["res_data"] != null)
            {
