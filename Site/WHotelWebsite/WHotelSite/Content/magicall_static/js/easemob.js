; (function () {
    ...
    easemobIM.config.defaultAvatar = setDefault(easemobIM.config.defaultAvatar, '/Content/magicall_static/img/avatar.png');//默认头像
    ...
    * 增加访客信息
    */
    easemobIM.config.visitor = setDefault(easemobIM.config.visitor, {
    ...
    link.href = '/Content/magicall_static/css/im.css';
    head.appendChild(link);

    var link_whim = document.createElement('link');
    link_whim.setAttribute('rel', 'stylesheet');
    link_whim.href = '/Content/magicall_static/css/whim.css';
    head.appendChild(link_whim);
    ...
    webim.innerHTML = "\
        ...
        <div id='EasemobKefuWebimChat' class='easemobWidgetWrapper" + (easemobIM.config.minimum ? " em-hide'" : "") + "'>\
            <div id='easemobWidgetHeader' class='easemobWidgetHeader-wrapper theme-color border-color' style=\"display:none\">\
            ...
            <div id='easemobWidgetSend' class='easemobWidget-send-wrapper'>\
                ...
                <textarea id='easemobWidgetSend_text' class='easemobWidget-textarea' spellcheck='false'></textarea>" +
            ...
            <iframe id='EasemobKefuWebimIframe' width='0' height='0' frameborder='0' src='https://kefu.am/webim/transfer.html'></iframe>\
        </div>\
    ";
    ...
    document.getElementById('EasemobKefuWebimIframe').onload = function () {
        ...
        var loadIm = function () {
            ...
            script.src = '/Content/magicall_static/js/im.js';
            head.appendChild(script);
            script = document.createElement('script');
            script.src = '/Content/magicall_static/js/whchat.js';
            head.appendChild(script);
            script = null;
        };
