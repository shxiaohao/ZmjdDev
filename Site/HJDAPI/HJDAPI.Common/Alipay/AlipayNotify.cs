...
namespace Com.Alipay
{
    ...
    public class Notify
    {
     ...
     //   private string _sign_type = "";             //签名方式
        ...
        public bool VerifyReturn(Dictionary<string, string> inputPara, string sign, string _sign_type)
        {
            //获取返回时的签名验证结果
            bool isSign = GetSignVeryfy(inputPara, sign,true,  _sign_type);
        ...
        /// <param name="sign">支付宝生成的签名结果</param>
        /// <returns>验证结果</returns>
        public bool VerifyNotify(Dictionary<string, string> inputPara, string sign , string _sign_type)
        {
            //解密
            if (_sign_type == "0001")
            {
            ...
            //获取返回时的签名验证结果
            bool isSign = GetSignVeryfy(inputPara, sign, false,  _sign_type);
        ...
        private bool GetSignVeryfy(Dictionary<string, string> inputPara, string sign, bool isSort, string _sign_type)
        {
            Dictionary<string, string> sPara = new Dictionary<string, string>();
