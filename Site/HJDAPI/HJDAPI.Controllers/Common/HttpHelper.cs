    ...
    public static class HttpHelper
    {
        ...
        public static string HttpPostWithFile(string url, string queryString, List<QueryParameter> files)
        {
            ...
            foreach (QueryParameter param in files)
            {
                ...
                //{
                //    case "local":
                //        fileData = Encoding.GetEncoding(ContentEncoding).GetString(File.ReadAllBytes(filePath));
                //        break;
                //    case "url":
                //        fileData = Encoding.GetEncoding(ContentEncoding).GetString(GetImageContent(filePath, filePath));
                //        break;
                //    default:
                //        fileData = Encoding.GetEncoding(ContentEncoding).GetString(GetImageContent(filePath, filePath));
                //        break;
                ...
                HttpWebRequest request = (HttpWebRequest)System.Net.HttpWebRequest.Create(filePath);
